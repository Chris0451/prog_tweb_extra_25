...
<div class="insert-center-form">
    <h3>Inserisci un nuovo centro di assistenza</h3>

    <div class="container-form">
        <div class="wrap-form">
            {{ html()->form()->method('POST')->route('center.store')->class(['data-form'])->attribute('enctype', 'multipart/form-data')->open()}}
                @csrf
                ...
                <div class="container-form-btn">
                    {{ html()->submit('Aggiungi Centro')->class(['form-btn1']) }}
                </div>
