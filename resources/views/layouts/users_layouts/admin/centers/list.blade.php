    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:center;"><img src="{{ $center->foto ? asset('storage/images/assistance_centers/'.$center->foto) : asset('images/placeholder.jpg')) }}" alt="Immagine centro {{ $centro->id }}" style="width: 30%; height: auto; border-radius: 8px;"></td>
                <td>
