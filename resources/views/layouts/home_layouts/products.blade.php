        ...
        <div class="card">
            ...
            <div class="row" style="display: flex; flex-wrap: wrap; gap: 20px;"> 
                @foreach($prodotti as $prodotto)
                    <div id="paginator">
                        <img src="{{ $prodotto->foto ? asset('storage/images/products/'.$prodotto->foto) : asset('images/placeholder.jpg') }}" alt="Immagine prodotto" style="width: 100%; height: auto; border-radius: 8px;">
                        <h3>{{ $prodotto->nome }}</h3>
